...
- [ ] *Bug*: Deleting multi-day booking does not update local cache correctly.
...
- [ ] Multi-day booking: If selecting some other entry than the first, must locate the first entry.
